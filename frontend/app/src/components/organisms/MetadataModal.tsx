            ...
            <table className="w-full border border-gray-200 dark:border-gray-600 rounded-lg">
              <thead>
                <tr className="bg-gray-100 dark:bg-gray-700">
                  <th className="px-4 py-3 text-left font-medium border-r border-gray-200 dark:border-gray-600">
                    Field Name
                  </th>
                  <th className="px-4 py-3 text-left font-medium border-r border-gray-200 dark:border-gray-600">
                    Data Type
                    ...
                    <td className="px-4 py-3 border-r border-gray-200 dark:border-gray-600">
                      {isEditing ? (
                        <select
                          ...
                          onChange={(e) =>
                            updateColumn(idx, "input_type", e.target.value)
                          }
